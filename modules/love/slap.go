...
func RunSlapCommand(session *discordgo.Session, message *discordgo.MessageCreate, _ string, args []string) {
	resp, err := http.Get("https://nekos.life/api/v2/img/slap")
	if err != nil {
	...
	embed := &discordgo.MessageEmbed{
		Description: message.Author.Mention() + " slaps you... ow.",
